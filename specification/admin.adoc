...
The messages page allows an authenticated user to create new messages, and edit and delete existing messages.

.Message page
image::images/messages-concept.png[{wide}]

The messages page consists of a <<main menu>> and a 